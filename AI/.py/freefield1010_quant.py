# -*- coding: utf-8 -*-
"""freefield1010_quant.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13-v4EPItUgcJRbWE7_dgU0UWORwPh6-u
"""
...
# -------------------------------------------------------
DATASET_ZIP_PATH = "/contents/freefield1010.zip"
DATASET_EXTRACT_PATH = "/contents/freefield1010"
METADATA_CSV_PATH = "/contents/freefield1010.csv"
...
def download_freefield1010 () :
  if not os.path.exists(DATASET_EXTRACT_PATH):
    # Download zip if it doesn ’t exist
    if not os.path.exists(DATASET_ZIP_PATH):
      print ("Downloading freefield1010 dataset ...")
...
DATA_DIR = download_freefield1010()
...
for filepath in all_wav_files:
    freefield1010 = os.path.basename(filepath)
    file_id = os.path.splitext(freefield1010)[0]  # e.g., "99687"
...
def representative_dataset():
    for i in range(100):  # sample 100 inputs
...
# Force input/output to int8 for MCU
...
tflite_filename = f"bird_activity_simplified{suffix}_int8.tflite"
